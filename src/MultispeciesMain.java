public class MultispeciesMain {
    ...
    public static void main(String[] args) {
        ...
        //todo - for 14% resistance, make sure no. of cores is 10
        //todo - for 15% resistance, do 5 blocks on 20 cores, as they take too long otherwise
        ...
        int nBlocks_14 = 10;
        int nBlocks_15 = 5; //no. of times a parallel run is performed.  total no. of runs = nCores * nBlocks.
        ...
        //todo - make sure the runID_offset is correct (add on 100 for 14, 25 for 16%)
        int runID_offset_14 = 200;
        int rumID_offset_15 = 200;
